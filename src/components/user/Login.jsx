    ...
    <>
      <form onSubmit={handleSubmit}>
        <DialogContent dividers>
          ...
          {isRegister && <PasswordField {...{ passwordRef: confirmPasswordRef, id: "confirmPassword", label: "confirm password" , autoFocus: false}} />}

        </DialogContent>
        <DialogActions sx={{
          justifyContent: 'space-between', px: '19px',
        }} >
      ...
      <DialogActions sx={{ justifyContent: 'center', py: '24px' }} >
        <Button variant="outlined" startIcon={<Google />} onClick={handleGoogleLogin} >Login with Google</Button>
      </DialogActions>
    </>
  )
}
